    ...
    <div className="p-10 bg-green-50 min-h-screen flex items-center justify-center">
      <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <div className="flex items-center mb-8">
          ...
          <div className="w-1/2">
            <div>
              <h1 className="text-5xl font-bold text-center text-green-600 mb-8 animate-fade-in">AI and Machine Learning with Python</h1>
        ...
        <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-lg p-8 mb-8">
          <h2 className="text-3xl font-bold text-center text-green-600 mb-4 animate-fade-in">Why Choose AI and Machine Learning?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex items-center animate-slide-left">
              ...
              <div className="ml-4">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Build Smart Models</h3>
            ...
            <div className="flex items-center animate-slide-right">
              ...
              <div className="ml-4">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Hands-On Data Analysis</h3>
            ...
            <div className="flex items-center animate-slide-right">
              ...
              <div className="ml-4">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Future-Proof Skills</h3>
        ...
        <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-lg p-8">
          <h2 className="text-3xl font-bold text-center text-green-600 mb-4 animate-fade-in">Python Programming Packages</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md animate-slide-left">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-green-600 ml-4">Basic Package</h3>
              </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md animate-slide-up">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-green-600 ml-4">Standard Package</h3>
              </div>
              <ul className="text-gray-700 mb-4 list-disc list-inside blue-star-list">
              ...
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-green-600 ml-4">Premium Package</h3>
              </div>
              <ul className="text-gray-700 mb-4 list-disc list-inside blue-star-list">
                <li className="mb-2">Fundamentals of Python: Master Python's core features and best practices.</li>
                <li className="mb-2">Machine Learning & AI: Dive into machine learning models and artificial intelligence concepts.</li>
                <li className="mb-2">Python Libraries: Work with essential libraries like NumPy and Scikit-learn.</li>
                <li className="mb-2">Model Evaluation: Learn to evaluate and validate machine learning models.</li>
                <li className="mb-2">Lasso and Ridge Regression: Explore regularization techniques for better model performance.</li>
                <li className="mb-2">Model Optimization: Fine-tune models for improved accuracy and efficiency.</li>
                <li className="mb-2">Projects: Develop 30+ advanced projects to showcase your expertise and prepare for real-world challenges.</li>
              </ul>
              <p className="text-green-500 mb-4">
                Start your journey for just <span className="bg-yellow-200 text-green-600 font-bold">$15 per class.</span>
              </p>
