...
function AboutUsMission() {
  ...
  return (
    <>
      ...
      <div className="bg-transparent grid grid-cols-1 md:grid-cols-2 mt-10 gap-8">
        <div className="flex items-center justify-center p-4">
          <img
            src="/about.png" 
            alt="About Us"
            className="w-full h-auto max-w-[400px] rounded-lg shadow-lg animate-fadeIn object-cover"
            loading="lazy" 
          />
        </div>
        <div className="flex items-center justify-center p-4">
      ...
      <div className="bg-transparent grid grid-cols-1 md:grid-cols-2 mt-16 gap-8">
        <div className="flex items-center justify-center p-4">
          <div className="p-6 bg-blue-100 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
            <h1 className="text-3xl font-bold text-yellow-500 mb-4">Our Mission</h1>
            <p className="text-lg text-gray-700">
